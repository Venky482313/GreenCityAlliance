		...
		<div class="container">
			<div class="table-wrap table-responsive">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<?php
						$query = $conn->prepare("SELECT * FROM consumers as a INNER JOIN votes as b ON a.ConsumerId = b.ConsumerID INNER JOIN productsservices as c ON b.ProductID = c.ProductID ");
						$query->execute();
