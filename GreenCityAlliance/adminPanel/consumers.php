		...
		<div class="container">
			<div class="table-wrap table-responsive">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<?php
						$query = $conn->prepare("SELECT * FROM residingareas as a INNER JOIN consumers as b ON a.AreaId = b.AreaID");
						$query->execute();
						...
						?>
							<tr>
								...
								<td> <?php echo $data['EnvironmentalInterests']; ?></td>
