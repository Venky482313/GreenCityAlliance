		...
		<div class="container">
			<div class="table-wrap table-responsive">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<?php
						$query = $conn->prepare("SELECT * FROM businesscategories as a INNER JOIN greenbusinesses as b ON a.CategoryID = b.BusinessCategoryID");
						$query->execute();
						...
						?>
							<tr>
								...
								<td> <?php echo $data['BusinessDescription']; ?></td>
								<td> <?php echo $data['BusinessType']; ?></td>
								<td> <?php echo $data['ContactInformation']; ?></td>
								<td> <?php echo $data['Email']; ?></td>
								<td> <?php echo $data['EnvironmentalBenefits']; ?></td>
								<td> <?php echo $data['PricingCategory']; ?></td>
