...
if (isset($_POST['submit'])) {
	...
	$env = $_POST['env'];
	$price = $_POST['price'];
	$conn->query("insert into `productsservices` (`BusinessID`,`ProductName`,`Description`,`Size`,`Environmentalbenefits`,`PricingCategory`) values ('$bCID','$name','$desc','$size','$env','$price') ");
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1">
						<a class="active nav-link py-3 px-0 px-lg-3 rounded" href="productsservices.php">Product Services</a>
					</li>
					<li class="nav-item mx-0 mx-lg-1">
			...
			<div class="row">
				...
				<div class="col-md-5">
					<form action="#" class="row" id="contactForm" method="post" enctype="multipart/form-data">
						<h3 class="mt-5">Product Services</h3>
