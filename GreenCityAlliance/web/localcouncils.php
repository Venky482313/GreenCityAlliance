...
if (isset($_POST['submit'])) {
	...
	$conn->query("insert into `localcouncils` (`CouncilName`, `CouncilDescription`) values ('$name', '$description') ");
	echo("<script>alert('Saved Successfully');</script>");
	echo("<script>window.location.href='residingareas.php';</script>");
}
?>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1">
						<a class="active nav-link py-3 px-0 px-lg-3 rounded" href="localcouncils.php">Local Councils</a>
					</li>
					<li class="nav-item mx-0 mx-lg-1">
			...
			<div class="row">
				...
				<div class="col-md-5">
					<form action="#" class="row" id="contactForm" method="post" enctype="multipart/form-data">
						<h3 class="mt-5">Local Councils</h3>
